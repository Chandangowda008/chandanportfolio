...
const MainPanel = ({ activeSection }) => {
  ...
  return (
    <div className="flex-1 bg-retro-light border-2 sm:border-4 border-retro-lightest shadow-pixel-lg overflow-hidden min-h-[70vh] md:min-h-0">
      {/* Screen Frame */}
      <div className="h-full flex flex-col">
        {/* CRT Screen Effect Header */}
        <div className="bg-retro-bg border-b-2 sm:border-b-4 border-retro-lightest p-2 flex items-center justify-between">
          ...
          <div className="text-retro-lightest text-[8px] animate-pulse">
            ● REC
          </div>
        </div>

        {/* Content Area */}
        <div className="flex-1 overflow-y-auto p-2 sm:p-4 bg-retro-bg">
