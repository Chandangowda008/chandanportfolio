  ...
  return (
    <div className="space-y-4">
      ...
      <div className="pixel-card animate-slideInUp">
        ...
        {/* Responsibilities */}
        <div className="bg-retro-bg border-2 border-retro-lighter p-3 mb-4">
          <p className="text-retro-lightest text-[10px] mb-2">KEY RESPONSIBILITIES:</p>
        ...
        <div className="bg-retro-bg border-2 border-retro-lighter p-3">
          <p className="text-retro-lightest text-[10px] mb-2">TECH STACK:</p>
          <div className="flex flex-wrap gap-2">
            {['React', 'Node.js', 'MongoDB', 'Express', 'AWS', 'Azure', 'Git', 'Docker'].map((tech, idx) => (
              <span 
                key={idx}
                className="bg-retro-light border-2 border-retro-lightest px-2 py-1 text-[8px] text-retro-lightest"
              >
                {tech}
              </span>
            ))}
      ...
      <div className="pixel-card bg-retro-bg border-retro-lighter">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div key={idx} className="bg-retro-light border-2 border-retro-lighter p-2">
              <p className="text-retro-lightest text-[8px] mb-1">{item.skill}</p>
